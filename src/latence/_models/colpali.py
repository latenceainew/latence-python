"""Pydantic models for the ColPali service."""
...
class ColPaliEmbedResponse(BaseResponse):
    """Response from the ColPali visual embedding service.
    ...
    embeddings: list[list[float]] = Field(description="Visual embeddings as float arrays")
    shape: list[int] = Field(description="Shape of embeddings [patches, dim]")
    ...
    patches: int | None = Field(default=None, description="Number of image patches")
