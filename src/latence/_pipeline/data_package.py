...
The DataPackage is the primary output a user receives from Latence AI.
...
class DataPackage(BaseModel):
    ...
    This is the primary output a user receives from Latence AI.
    ...
    def _generate_readme(self) -> str:
        ...
        lines.extend(
            [
                "",
                "---",
                "*Generated by Latence AI Data Intelligence Pipeline*",
            ]
        )
        return "\n".join(lines)
